...
const ROWS: SeedRow[] = [
  ...
  // —— expanded bar shelf (SEED 7 growth) ——
  { displayName: "Plantation 3 Stars Rum", normalizedName: "rum", category: "spirit", value: 0.65, unit: "bottle", expiry: null, location: "bar_shelf" },
  { displayName: "Del Maguey Vida Mezcal", normalizedName: "mezcal", category: "spirit", value: 0.5, unit: "bottle", expiry: null, location: "bar_shelf" },
  { displayName: "Hennessy VS", normalizedName: "cognac", category: "spirit", value: 0.4, unit: "bottle", expiry: null, location: "bar_shelf" },
  { displayName: "Laphroaig 10", normalizedName: "scotch", category: "spirit", value: 0.55, unit: "bottle", expiry: null, location: "bar_shelf" },
  { displayName: "Dolin Dry Vermouth", normalizedName: "dry vermouth", category: "mixer", value: 0.6, unit: "bottle", expiry: 60, location: "fridge" },
  { displayName: "Carpano Antica Formula", normalizedName: "sweet vermouth", category: "mixer", value: 0.55, unit: "bottle", expiry: 45, location: "fridge" },
  { displayName: "Green Chartreuse", normalizedName: "chartreuse", category: "spirit", value: 0.35, unit: "bottle", expiry: null, location: "bar_shelf" },
  { displayName: "St-Germain", normalizedName: "elderflower", category: "spirit", value: 0.45, unit: "bottle", expiry: null, location: "bar_shelf" },
  { displayName: "Kahlúa", normalizedName: "coffee liqueur", category: "spirit", value: 0.5, unit: "bottle", expiry: null, location: "bar_shelf" },
  { displayName: "Peychaud's Bitters", normalizedName: "peychauds", category: "mixer", value: 0.7, unit: "bottle", expiry: null, location: "bar_shelf" },
  { displayName: "Fever-Tree Ginger Ale", normalizedName: "ginger ale", category: "mixer", value: 4, unit: "count", expiry: 90, location: "bar_shelf" },
  { displayName: "San Pellegrino Aranciata", normalizedName: "orange soda", category: "mixer", value: 4, unit: "count", expiry: 120, location: "pantry" },
  { displayName: "Fresh grapefruit juice", normalizedName: "grapefruit", category: "mixer", value: 0.5, unit: "bottle", expiry: 5, location: "fridge", tags: ["near-expiry"] },

  // —— expanded fridge ——
  { displayName: "Atlantic salmon fillet", normalizedName: "salmon", category: "protein", value: 350, unit: "g", expiry: 2, location: "fridge", tags: ["near-expiry"] },
  { displayName: "Firm tofu", normalizedName: "tofu", category: "protein", value: 400, unit: "g", expiry: 10, location: "fridge" },
  { displayName: "Ground beef (80/20)", normalizedName: "beef", category: "protein", value: 450, unit: "g", expiry: 2, location: "fridge", tags: ["near-expiry"] },
  { displayName: "Goat cheese log", normalizedName: "goat cheese", category: "dairy", value: 150, unit: "g", expiry: 14, location: "fridge" },
  { displayName: "Blue cheese wedge", normalizedName: "blue cheese", category: "dairy", value: 120, unit: "g", expiry: 18, location: "fridge" },
  { displayName: "Fresh dill", normalizedName: "dill", category: "herb", value: 1, unit: "bunch", expiry: 6, location: "fridge" },
  { displayName: "Rosemary sprig", normalizedName: "rosemary", category: "herb", value: 1, unit: "bunch", expiry: 10, location: "fridge" },
  { displayName: "Thyme", normalizedName: "thyme", category: "herb", value: 1, unit: "bunch", expiry: 8, location: "fridge" },
  { displayName: "Kefir", normalizedName: "kefir", category: "dairy", value: 1, unit: "count", expiry: 12, location: "fridge" },
  { displayName: "Leftover roast vegetables", normalizedName: "roasted vegetables", category: "produce", value: 300, unit: "g", expiry: 3, location: "fridge", tags: ["near-expiry"] },
  { displayName: "Pickled red onions", normalizedName: "pickled onion", category: "condiment", value: 1, unit: "count", expiry: 30, location: "fridge" },

  // —— expanded pantry ——
  { displayName: "Quinoa", normalizedName: "quinoa", category: "pantry", value: 400, unit: "g", expiry: null, location: "pantry" },
  { displayName: "Couscous", normalizedName: "couscous", category: "pantry", value: 300, unit: "g", expiry: null, location: "pantry" },
  { displayName: "Cinnamon sticks", normalizedName: "cinnamon", category: "pantry", value: 1, unit: "count", expiry: null, location: "pantry" },
  { displayName: "Cardamom pods", normalizedName: "cardamom", category: "pantry", value: 1, unit: "count", expiry: null, location: "pantry" },
  { displayName: "Whole nutmeg", normalizedName: "nutmeg", category: "pantry", value: 1, unit: "count", expiry: null, location: "pantry" },
  { displayName: "Bay leaves", normalizedName: "bay leaf", category: "pantry", value: 1, unit: "count", expiry: null, location: "pantry" },
  { displayName: "Star anise", normalizedName: "star anise", category: "pantry", value: 1, unit: "count", expiry: null, location: "pantry" },
  { displayName: "Gochujang", normalizedName: "gochujang", category: "condiment", value: 1, unit: "count", expiry: 180, location: "fridge" },
  { displayName: "Sriracha", normalizedName: "sriracha", category: "condiment", value: 1, unit: "bottle", expiry: 300, location: "pantry" },
  { displayName: "Raw almonds", normalizedName: "almonds", category: "pantry", value: 200, unit: "g", expiry: 120, location: "pantry" },
  { displayName: "Dried cranberries", normalizedName: "cranberries", category: "pantry", value: 150, unit: "g", expiry: 200, location: "pantry" },
  { displayName: "Baking powder", normalizedName: "baking powder", category: "pantry", value: 1, unit: "count", expiry: null, location: "pantry" },
  { displayName: "Dutch-process cocoa", normalizedName: "cocoa", category: "pantry", value: 1, unit: "count", expiry: null, location: "pantry" },
  { displayName: "Apple cider vinegar", normalizedName: "apple cider vinegar", category: "condiment", value: 1, unit: "bottle", expiry: null, location: "pantry" },
  { displayName: "Balsamic vinegar", normalizedName: "balsamic", category: "condiment", value: 1, unit: "bottle", expiry: null, location: "pantry" },
  { displayName: "Smoked sea salt", normalizedName: "smoked salt", category: "condiment", value: 1, unit: "count", expiry: null, location: "pantry" },
  { displayName: "Panko breadcrumbs", normalizedName: "panko", category: "pantry", value: 1, unit: "count", expiry: 180, location: "pantry" },
  { displayName: "Dried porcini", normalizedName: "porcini", category: "pantry", value: 50, unit: "g", expiry: null, location: "pantry" },
  ...
  { displayName: "Chicken thighs", normalizedName: "chicken", category: "protein", value: 800, unit: "g", expiry: 90, location: "freezer" },
  { displayName: "Vanilla ice cream", normalizedName: "ice cream", category: "dairy", value: 1, unit: "count", expiry: 90, location: "freezer" },
  { displayName: "Frozen spinach", normalizedName: "spinach", category: "produce", value: 300, unit: "g", expiry: 180, location: "freezer" },
  { displayName: "Pizza dough ball", normalizedName: "dough", category: "pantry", value: 1, unit: "count", expiry: 60, location: "freezer" },
  { displayName: "Edamame", normalizedName: "edamame", category: "produce", value: 400, unit: "g", expiry: 180, location: "freezer" },
];
