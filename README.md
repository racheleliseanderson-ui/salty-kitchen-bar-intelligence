...
Validation desk and working prototype for the Kitchen & Bar layer beside [Menu Builder](https://salty-menu-builder.vercel.app/).
...
| Handoff | Availability Packet **1.0** — user-initiated only. No recipes, no guarantees, no silent inference. |
...
| `/handoff` | Assemble, copy, download Packet 1.0; open Menu Builder |
...
- Packet send is explicit. Menu Builder stays independent.
